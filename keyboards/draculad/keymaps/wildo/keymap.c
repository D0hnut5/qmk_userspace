...
#include "encoder_map_draculad.h"
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	[_BASE] = LAYOUT_wildo(
		...
		___BASE_3_L___,                              ___BASE_3_R___,
                ENC_BASE,                     ENC_BASE,
            ___BASE_3THM_SPLT_L___,  ___BASE_3THM_SPLT_R___
	),
	[_NUM] = LAYOUT_wildo(
		...
		___NUM_3_L___,                               ___NUM_3_R___,
	              ENC_NUM,                      ENC_NUM, 
            ___NUM_3THM_SPLT_L___,  ___NUM_3THM_SPLT_R___
	),
	[_NAV] = LAYOUT_wildo(		
		...
		___NAV_3_L___,                               ___NAV_3_R___,
		            ENC_NAV,                      ENC_NAV, 
            ___NAV_3THM_SPLT_L___,  ___NAV_3THM_SPLT_R___
	),
	[_MSE] = LAYOUT_wildo(
		...
		___MSE_3_L___,                               ___MSE_3_R___,
		            ENC_MSE,                      ENC_MSE,
            ___MSE_3THM_SPLT_L___,  ___MSE_3THM_SPLT_R___
	),
	[_FUN] = LAYOUT_wildo(
		...
		___FUN_3_L___,                               ___FUN_3_R___,
		            ENC_FUN,                      ENC_FUN, 
            ___FUN_3THM_SPLT_L___,  ___FUN_3THM_SPLT_R___
	),
	[_SYM] = LAYOUT_wildo(
		...
		___SYM_3_L___,                               ___SYM_3_R___,
		            ENC_SYM,                      ENC_SYM, 
            ___SYM_3THM_SPLT_L___,  ___SYM_3THM_SPLT_R___
	),
	[_ADD] = LAYOUT_wildo(
		...
		___ADD_3_L___,                               ___ADD_3_R___,
		            ENC_ADD,                      ENC_ADD, 
            ___ADD_3THM_SPLT_L___,  ___ADD_3THM_SPLT_R___
	)
};
